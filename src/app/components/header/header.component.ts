  ...
  template: `
    ...
    >
      ...
      >
        ...
        <div class="p-0 p-sm-3  d-flex align-items-center ">
          ...
          <div class="d-flex">
            <button class="btn d-block ml-auto ml-md-0 navbar__svg-icon ">
              <svg
                aria-hidden="true"
                viewBox="0 0 32 32"
                xmlns="http://www.w3.org/2000/svg"
